...
public class TextEditor {
  ...
  /**
   * Replace all occurrences of the regular expression with the replacement. The
   * replacement string can contain $1, $2 etc. referring to matched groups in
  ...
  /**
   * Replace all occurrences of the Pattern. The Replacement object's replace()
   * method is called on each match, and it provides a replacement, which is
   * placed literally (i.e., without interpreting $1, $2 etc.)
   *
   * @param pattern
   * @param replacement
   * @return
  ...
  /**
   * Remove all occurrences of the given regex pattern, replacing them with the
   * empty string.
   *
   ...
   *
   * @param depth - How many levels of tags-within-tags to allow. The example <a
   *              href="<MTFoo>"> has depth 2.
   */
